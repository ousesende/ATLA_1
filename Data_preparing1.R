...
IGE_tourism<-read.csv('C:/Users/Antía/Documents/ATLANTECO/R/ATLA_1/DATA/IGE_Tourist_26072023.csv')
head(IGE_tourism)
View(IGE_tourism)

try_IGE_tourism<-read.csv('C:/Users/Antía/Documents/ATLANTECO/R/ATLA_1/DATA/IGE_Tourist_26072023_M_R.csv')
...
#Fix codigo variable - Substitute NA in Codigo by ""

try_IGE_tourism[is.na(try_IGE_tourism)] <- ""
str(try_IGE_tourism$Tipo.aloxamento)
class(try_IGE_tourism$Codigo)
class(try_IGE_tourism$Area)
...
#****Codigo funcinou nalgún intento, pero non sei todavia como/porque?
